;(function() {
  ...
  GameView.prototype.drawIntro = function(ctx) {
    ...
    ctx.fillText("Welcome to Space Shooter", SpaceInvaders.Game.DIM_X / 2, SpaceInvaders.Game.DIM_Y / 2);
    ...
    if (this.blinkCount >= GameView.FPS) {
      ...
      ctx.fillText("Press 'ENTER' to Start", SpaceInvaders.Game.DIM_X / 2, SpaceInvaders.Game.DIM_Y / 2 + 60);
      this.blinkCount += 1;
    }

    ctx.font = "20px gameFont";
    ctx.fillText("Controls: ↑↓←→ or w-a-s-d to move, space to shoot", SpaceInvaders.Game.DIM_X / 2, SpaceInvaders.Game.DIM_Y / 2 + 140);
