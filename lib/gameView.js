;(function() {
  ...
  GameView.prototype.drawIntro = function(ctx) {
    ...
    ctx.fillText("Space Shooter", SpaceInvaders.Game.DIM_X / 2, SpaceInvaders.Game.DIM_Y / 2 - 100);
    ctx.fillStyle = '#FF0000';
    ctx.font = "70px ARCADE";
    ctx.fillText("Space Shooter", SpaceInvaders.Game.DIM_X / 2 + 2, SpaceInvaders.Game.DIM_Y / 2 - 98);
    ctx.fillStyle = '#FFF';
    ...
    if (this.blinkCount >= GameView.FPS) {
      ...
      ctx.fillText("Hit 'ENTER' to Start", SpaceInvaders.Game.DIM_X / 2, SpaceInvaders.Game.DIM_Y / 2 );
      this.blinkCount += 1;
    }
    ...
    ctx.fillText("Move: Arrow keys or w,a,s,d", SpaceInvaders.Game.DIM_X / 2, SpaceInvaders.Game.DIM_Y / 2 + 140);
  ...
  GameView.prototype.drawGameOver = function(ctx) {
    ...
    if (this.blinkCount >= GameView.FPS) {
      ...
      ctx.fillStyle = '#FF0000';
      ctx.fillText("Game Over", SpaceInvaders.Game.DIM_X / 2+2, SpaceInvaders.Game.DIM_Y / 2 - 98);
      ctx.fillStyle = '#FFF';
    ...
    ctx.font = "40px ARCADE";
    ctx.fillText("Hit 'esc' to return", SpaceInvaders.Game.DIM_X / 2, SpaceInvaders.Game.DIM_Y / 2 );
    ...
    ctx.font = "25px ARCADE";
    ctx.fillText(this.game.displayScore(), SpaceInvaders.Game.DIM_X / 2, SpaceInvaders.Game.DIM_Y / 2 + 140);
    this.updateStars();
  };
